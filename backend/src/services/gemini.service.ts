...
// Usando gemini-flash-latest (1.5) por ter uma quota mais estável no free tier
const GEMINI_URL = `https://generativelanguage.googleapis.com/v1/models/gemini-flash-latest:generateContent?key=${GEMINI_API_KEY}`;
